...
public class AppointmentService {
    ...
    public ResAppointment updateAppointmentOfCashier(String id, ReqAppointment reqAppointment, HttpSession session) {
        ...
        User doctor = userRepository.findByWalletAddress(reqAppointment.getDoctorAddress()).get();
